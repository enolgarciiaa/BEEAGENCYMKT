...
export default function TextoCreativo() {
  ...
  const handleHover = (images) => {
    const randomized = images.map((src) => ({
      src,
      rotation: getRandomRotation(), // ✅ devuelve '25deg' o similar
  ...
  return (
    <section className="w-full mb-48 relative overflow-hidden ">
      {/* TÍTULO */}
      <div className="relative max-w-5xl mx-6 mt-24 text-left z-10 lg:ml-20">
      ...
      {/* TEXTO A LA DERECHA */}
      <div className="relative flex sm:justify-center mt-[100px] sm:mt-[250px] md:mt-[200px] px-10 z-10">
