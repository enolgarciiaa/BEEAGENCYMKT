...
export default function ImpulsaMarcaservices() {
  ...
  return (
    <section className="relative w-full min-h-[100vh] md:min-h-[80vh] lg:min-h-[70vh] xl:min-h-screen text-white  overflow-hidden">
      ...
      >
        <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tight bg-clip-text mt-32 text-transparent bg-gradient-to-br from-slate-300 to-slate-400">
