    ...
    <footer className="bg-black text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            ...
            <address className="not-italic text-gray-300">
              <p className="mb-4 flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <nav className="space-y-3">
              <Link to="/" className="block text-gray-300 hover:text-yellow-400 transition-colors">Inicio</Link>
              <Link to="/beeagency" className="block text-gray-300 hover:text-yellow-400 transition-colors">BeeAgency</Link>
              <Link to="/services" className="block text-gray-300 hover:text-yellow-400 transition-colors">Servicios</Link>
              <Link to="/blog" className="block text-gray-300 hover:text-yellow-400 transition-colors">Blog</Link>
              <Link to="/contact" className="block text-gray-300 hover:text-yellow-400 transition-colors">Contacto</Link>
            </nav>
          </motion.div>
          ...
          >
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <a href="https://wa.me/34672407400" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-yellow-400 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          ...
          >
            <Link to="/politica-privacidad" className="hover:text-yellow-400 transition-colors">Política de privacidad</Link>
            <Link to="/terminos-condiciones" className="hover:text-yellow-400 transition-colors">Términos y condiciones</Link>
            <Link to="/cookies" className="hover:text-yellow-400 transition-colors">Política de cookies</Link>
          </motion.div>
        </div>
      </div>
    </footer>
